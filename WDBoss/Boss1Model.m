...
- (void)setTextures
{
   // WDTextureManager *m = [WDTextureManager shareTextureManager];
    ...
    self.standArr = [self loadWithImageName:@"npc_Base_stay_" count:9];
    self.sitArr = [self loadWithImageName:@"npc_Base_sit_" count:6];
    self.learnArr = [self loadWithImageName:@"npc_Base_learn_" count:2];
