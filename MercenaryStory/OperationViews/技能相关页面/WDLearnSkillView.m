...
- (void)iceWizard:(NSInteger)index{
    ...
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    NSInteger time1 = [defaults integerForKey:kPriest_skill_1];
    NSInteger time3 = [defaults integerForKey:kPriest_skill_3];
    NSInteger time4 = [defaults integerForKey:kPriest_skill_4];
    ...
    NSString *name = [NSString stringWithFormat:@"%@_%ld",kPriest,index];
   ...
   // label.backgroundColor = [UIColor blackColor];
    ...
    if (isLearn) {
        ...
        if (index - 1 >= 0) {
            NSInteger index2 = index - 1;
            BOOL beforeIsLearn = [defaults boolForKey:[NSString stringWithFormat:@"%@_%ld",kPriest,index2]];
            if (beforeIsLearn) {
                image = [UIImage imageNamed:@"select_no"];
            }else{
                image = [UIImage imageNamed:@"lock"];
